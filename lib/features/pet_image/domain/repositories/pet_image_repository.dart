...
abstract class PetImageRepository {
  ...
  sendImageToPet({required String imageUrl, DateTime? takenAt, String? text});

  /// Gửi reaction cho một ảnh
  ///
  /// [imageId]: ID của ảnh (actionId)
  /// [emoji]: Loại cảm xúc ("❤️", "😍", v.v.)
  /// [count]: Số lượng gom nhóm (debounce)
  ///
  /// Returns: ApiResult<bool> trạng thái thành công
  ...
  Future<ApiResult<PetImage>> getPetImageDetails(String imageId);
}
